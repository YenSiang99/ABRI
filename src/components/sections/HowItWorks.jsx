      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {STEPS.map((step, index) => (
            <div
              key={step.title}
              className="rounded-lg border border-grey-200 bg-white p-[30px] transition-all hover:-translate-y-0.5 hover:shadow-md"
            >
              ...
              <p className="text-[14.5px] text-grey-600">{step.description}</p>
              <span className="mt-4 inline-block rounded-[5px] bg-surface-2 px-2.5 py-1 font-mono text-[11.5px] text-grey-500">
                {step.tag}
              </span>
            </div>
          ))}
        ...
        <p className="mt-11 text-center text-[15px] text-grey-500 italic">
