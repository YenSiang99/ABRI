    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <StatCard
          ...
          value={currentUser.vouchesReceived}
          hint="+2 this week"
          icon={Handshake}
        />
        <StatCard
          label="Vouches given"
          value={currentUser.vouchesGiven}
          hint="Give-first: keep going"
          icon={TrendingUp}
        />
        <StatCard
        ...
        <StatCard
          ...
          hint={tierLabel[currentUser.tier]}
          icon={ShieldCheck}
        />
        <StatCard
          label="Vouch level"
          value={ladderLabel[currentUser.ladder]}
